                     ...
                     <h5 class="h5"><a href="#">Topwear</a></h5>
                         <ul>
                            ...
                            <li><a href="https://localhost:44350/Home/casualshirtsmens">Casual Shirts</a></li>
                             <li><a href="https://localhost:44350/Home/UserPortal"> Shirts</a></li>
     ...
     <div id="b">
        <div class="div" id="d1">
            <h5 class="h5"><a href="#">Boys Clothing</a></h5>
                <ul>
                   <li><a href="https://localhost:44350/Home/tShirtsKids">T-Shirts</a></li>
                   <li><a href="https://localhost:44350/Home/shirtsKids">Shirts</a></li>
                ...
                <div  id="d2">
                 ...
                 <ul>
                    <li><a href="https://localhost:44350/Home/dresesKids">Dresses</a></li>
                    <li><a href="#">Tops</a></li>
                    <li><a href="#">Tshirts</a></li>
                    <li><a href="#">Clothing Sets</a></li>
  ...
  <div id="b">
     <div class="div" id="d1">
         <h5 class="h5"><a href="#">Bed Linen & Furnishing</a></h5>
             <ul>
                <li><a href="https://localhost:44350/Home/bedRunnerHome">Bed Runners</a></li>
                <li><a href="https://localhost:44350/Home/mattressHome">Mattress Protectors</a></li>
    ...
    <div id="d3">
       ...
       <ul>
        <li><a href="https://localhost:44350/Home/bedRunnerHome">Table Runners</a></li>
  ...
  <div id="b">
     <div class="div" id="d1">
         <h5 class="h5"><a href="#">Makeup</a></h5>
             <ul>
                <li><a href="https://localhost:44350/Home/lipsticBeauty">Lipstick</a></li>
        ...
        <div id="akash7">
          <div id="b">
             <div class="div" id="d1">
                 ...
                 <hr>
                     <ul>
                        <li><a href="https://localhost:44350/Home/orderdetails">Order</a></li>
                        <li><a href="https://localhost:44350/Home/wishlist</a></li>
                  ...
                  <ul>
                         <li><a href="https://localhost:44350/Home/bedRunnerHome">Myntra credit</a></li>
                           <li><a href="https://localhost:44350/Home/mattressHome">Coupons</a></li>
                         <li><a href="#">Saved cards</a></li>
                         <li><a href="https://localhost:44350/Home/Login">Lagout</a></li
                 </ul>
...
let searchFunction = () => {
  let searchData1 = [
    ...
    { Title:  "Beauty Products Womens", Path: "/nav_itemsHTML/lakmeBeauty.html" },
      { Title: "Lipstic Women", Path: "https://localhost:44350/Home/lipsticBeauty" },
